...
static const char *fonts[]          = { "DejaVuSansMono Nerd Font:size=18" }; //, "JoyPixels:pixelsize=18:antialias=true:autohint=true" };
static const char dmenufont[]       = "hack:size=18";
static char normbgcolor[]           = "#1b1918";
static char normbordercolor[]       = "#444444";
static char normfgcolor[]           = "#a8a19f";
static char selfgcolor[]            = "#a8a19f";
static char selbordercolor[]        = "#f22c40";
static char selbgcolor[]            = "#f22c40";
...
static Key keys[] = {
	...
	{ MODKEY|AltMask,			XK_q,		spawn,	SHCMD("killall dwm") },
	{ MODKEY|AltMask,			XK_r,		spawn,	SHCMD("killall dwm; startx") },
  ...
  { HYPERKEY|ShiftMask,   XK_equal,  spawn,    SHCMD("cppref") },
